...
export const resetProfile = (
  ...
  cy.request({
    ...
    body: {
      ...
      username: 'admina',
      avatar:
        'https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse3.mm.bing.net%2Fth%3Fid%3DOIP.YiaRzLjKeita5FGhjVu5ZQHaHa%26pid%3DApi&f=1&ipt=94b07cb95209f68ee67c1876517815ad54c69e96abdddd78766316ff4cccdd9d&ipo=images'
    },
    headers: {
      authorization: 'token'
    }
