module.exports = {
    ...
    plugins: ['react', 'i18next', 'react-hooks', 'feature-sliced-plugin-custom', 'unused-imports', 'import'],
    rules: {
        ...
        'i18next/no-literal-string': ['error', { markupOnly: true, 'jsx-attributes': { exclude: ['data-testid'] } }],
