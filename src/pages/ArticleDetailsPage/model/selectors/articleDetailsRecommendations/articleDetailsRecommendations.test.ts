...
describe('articleDetailsRecommendations', () => {
    test('Should return value "isLoading"', () => {
        ...
        expect(getArticleDetailsRecommendationsLoading(state as StateSchema)).toBe(true)
    })
    ...
    test('Should work with empty state', () => {
        ...
        expect(getArticleDetailsRecommendationsLoading(state as StateSchema)).toEqual(undefined)
