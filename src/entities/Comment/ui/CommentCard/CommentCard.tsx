...
const CommentCard: FC<CommentCardProps> = memo((props) => {
  ...
  if (isLoading) {
    return (
      <div className={classNames(styles.CommentCard, mods, additionsClasses)} data-testid={dataTestId + '.CommentCardLoader'}>
  ...
  return (
    <div className={classNames(styles.CommentCard, mods, additionsClasses)} data-testid={dataTestId + '.CommentCardItem'}>
